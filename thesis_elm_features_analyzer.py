...
n_selections = 20 #Number of random training set partitions
n_repeats = 5 #Number of repeats of the overall procedure
param_grid = dict()
param_grid['classification__C'] = np.logspace(-2, 2, 9)
...
for outer_run in range(n_repeats):
    ...
    print('Means: ', results_means)##/
    print('SDs: ', np.std(results_table, axis = 0))##/
